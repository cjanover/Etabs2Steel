...
${OBJECTDIR}/ConfigFunctions.o: ConfigFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigFunctions.o ConfigFunctions.cpp

${OBJECTDIR}/Coord.o: Coord.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Coord.o Coord.cpp

${OBJECTDIR}/DampingFunctions.o: DampingFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DampingFunctions.o DampingFunctions.cpp
...
${OBJECTDIR}/DeckProp.o: DeckProp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeckProp.o DeckProp.cpp

${OBJECTDIR}/Diaphragm.o: Diaphragm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Diaphragm.o Diaphragm.cpp
...
${OBJECTDIR}/EtabsAreaProps.o: EtabsAreaProps.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EtabsAreaProps.o EtabsAreaProps.cpp

${OBJECTDIR}/EtabsLine.o: EtabsLine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EtabsLine.o EtabsLine.cpp

${OBJECTDIR}/EtabsNode.o: EtabsNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EtabsNode.o EtabsNode.cpp

${OBJECTDIR}/EtabsWall.o: EtabsWall.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EtabsWall.o EtabsWall.cpp

${OBJECTDIR}/FloatCompare.o: FloatCompare.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FloatCompare.o FloatCompare.cpp

${OBJECTDIR}/FoundationNode.o: FoundationNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FoundationNode.o FoundationNode.cpp
...
${OBJECTDIR}/LoadCombination.o: LoadCombination.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LoadCombination.o LoadCombination.cpp

${OBJECTDIR}/LoadPattern.o: LoadPattern.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LoadPattern.o LoadPattern.cpp
...
${OBJECTDIR}/ModelForces.o: ModelForces.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModelForces.o ModelForces.cpp

${OBJECTDIR}/NewElement.o: NewElement.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NewElement.o NewElement.cpp

${OBJECTDIR}/NodalRestraint.o: NodalRestraint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodalRestraint.o NodalRestraint.cpp
...
${OBJECTDIR}/OutputModel.o: OutputModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OutputModel.o OutputModel.cpp
...
${OBJECTDIR}/PointSpring.o: PointSpring.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointSpring.o PointSpring.cpp

${OBJECTDIR}/PointSpringFunctions.o: PointSpringFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointSpringFunctions.o PointSpringFunctions.cpp

${OBJECTDIR}/Releases.o: Releases.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Releases.o Releases.cpp

${OBJECTDIR}/RestraintFunctions.o: RestraintFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RestraintFunctions.o RestraintFunctions.cpp

${OBJECTDIR}/SectionFunctions.o: SectionFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SectionFunctions.o SectionFunctions.cpp

${OBJECTDIR}/Slab.o: Slab.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Slab.o Slab.cpp

${OBJECTDIR}/SpecialColumn.o: SpecialColumn.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpecialColumn.o SpecialColumn.cpp

${OBJECTDIR}/StaticLoad.o: StaticLoad.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StaticLoad.o StaticLoad.cpp

${OBJECTDIR}/SteelArea.o: SteelArea.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SteelArea.o SteelArea.cpp

${OBJECTDIR}/SteelLine.o: SteelLine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SteelLine.o SteelLine.cpp

${OBJECTDIR}/SteelNode.o: SteelNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SteelNode.o SteelNode.cpp

${OBJECTDIR}/SteelSection.o: SteelSection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SteelSection.o SteelSection.cpp

${OBJECTDIR}/Story.o: Story.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Story.o Story.cpp

${OBJECTDIR}/TimeHistory.o: TimeHistory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TimeHistory.o TimeHistory.cpp

${OBJECTDIR}/VerticalConnFunctions.o: VerticalConnFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VerticalConnFunctions.o VerticalConnFunctions.cpp

${OBJECTDIR}/VerticalConstraint.o: VerticalConstraint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VerticalConstraint.o VerticalConstraint.cpp

${OBJECTDIR}/WallFunctions.o: WallFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WallFunctions.o WallFunctions.cpp
